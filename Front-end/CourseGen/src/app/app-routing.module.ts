...
const routes: Routes = [
  ...
  { path: 'generate-content', component: GenerateContentComponent, data: { title: 'GENERATE COURSE', showBackButton: true } },
  // { path: 'admin-generate-content', component: AdminGenerateContentComponent },
  { path: 'view-courses', component: ViewCoursesComponent, data: { title: 'VIEW CONTENT', showBackButton: true } },
  // { path: 'admin-view-courses', component: AdminViewCoursesComponent },
  { path: 'view-content', component: ViewContentComponent, data: { title: 'VIEW COURSES', showBackButton: true } },
  // { path: 'admin-view-content', component: AdminViewContentComponent },
  { path: 'admin-login', component: AdminLoginComponent },
  { path: 'profile-management', component: ProfileManagementComponent, data: { title: 'PROFILE MANAGEMENT', showBackButton: true } },
  // { path: 'admin-dashboard', component: AdminDashboardComponent },
  { path: 'view-users', component: ViewUsersComponent, data: { title: 'VIEW ALL USERS', showBackButton: true } },
  { path: 'user-management', component: UserManagementComponent, data: { title: 'USER MANAGEMENT', showBackButton: true } },
