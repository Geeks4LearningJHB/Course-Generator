...
const routes: Routes = [
  ...
  { path: 'forgot-password', component: ForgotPasswordComponent, data: { tittle:'PASSWORD RESET', showBackButton:true, previous: '/dashboard'} },
  { path: 'dashboard', component: DashboardComponent, data: { title: 'COURSE GENERATOR', showBackButton: false } },
  { path: 'generate-content', component: GenerateContentComponent, data: { title: 'GENERATE COURSE', showBackButton: true,  previous: '/dashboard' } },
  // { path: 'admin-generate-content', component: AdminGenerateContentComponent },
  { path: 'view-courses', component: ViewCoursesComponent, data: { title: 'VIEW CONTENT', showBackButton: true, previous: '/dashboard' } },
  // { path: 'admin-view-courses', component: AdminViewCoursesComponent },
  { path: 'view-content', component: ViewContentComponent, data: { title: 'VIEW COURSES', showBackButton: true, previous: '/view-courses' } },
  // { path: 'admin-view-content', component: AdminViewContentComponent },
  { path: 'admin-login', component: AdminLoginComponent },
  { path: 'profile-management', component: ProfileManagementComponent, data: { title: 'PROFILE MANAGEMENT', showBackButton: true, previous: '/dashboard' } },
  // { path: 'admin-dashboard', component: AdminDashboardComponent },
  { path: 'view-users', component: ViewUsersComponent, data: { title: 'VIEW ALL USERS', showBackButton: true, previous: '/dashboard' } },
  { path: 'user-management', component: UserManagementComponent, data: { title: 'USER MANAGEMENT', showBackButton: true, previous: '/dashboard' } },
